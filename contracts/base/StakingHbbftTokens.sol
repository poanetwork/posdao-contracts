...
contract StakingHbbftTokens is IStakingHbbftTokens, StakingHbbftBase {
    ...
    function claimReward(
        ...
        IBlockRewardHbbftTokens blockRewardContract = IBlockRewardHbbftTokens(validatorSetContract.blockRewardContract());
